...
#import <iAd/iAd.h>
#import "ContainerBanner_Coded.h"
#import "ContainerBannerTextViewController.h"

@interface ContainerBanner_Coded () <ADBannerViewDelegate>
@end

@implementation ContainerBanner_Coded{
...
- (instancetype)init{
    ...
    ContainerBannerTextViewController *textViewController = [[ContainerBannerTextViewController alloc] init];
    ...
    if (self != nil) {
        ...
        _contentController = textViewController;
