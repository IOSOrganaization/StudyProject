...
NSString *const AAPLAppDelegateMainStoryboardName = @"Lister";
...
@interface Lister () <UISplitViewControllerDelegate>
 ...
 * the main storyboard.
 */
@property (nonatomic, readonly) IBOutlet UISplitViewController *splitViewController;
...
- (void)awakeFromNib{
    [XTFMylog info:@"Storyboard包含对象初始化 -> Lister"];
...
- (BOOL)splitViewController:(UISplitViewController *)splitViewController collapseSecondaryViewController:(UIViewController *)secondaryViewController ontoPrimaryViewController:(UIViewController *)primaryViewController {
    [XTFMylog info:@"SplitView 页面控制器委托接口协议 -> splitViewController:collapseSecondaryViewController:ontoPrimaryViewController:"];
...
- (UIViewController *)splitViewController:(UISplitViewController *)splitViewController separateSecondaryViewControllerFromPrimaryViewController:(UIViewController *)primaryViewController {
    [XTFMylog info:@"SplitView 页面控制器委托接口协议 -> splitViewController:separateSecondaryViewControllerFromPrimaryViewController:"];
...
- (void)handleUbiquityIdentityDidChangeNotification:(NSNotification *)notification {
    [XTFMylog info:@"提醒控制器触发 handleUbiquityIdentityDidChangeNotification:"];
...
- (void)setupUserStoragePreferences {
    [XTFMylog info:@"设置用户保存的参数变量 setupUserStoragePreferences"];
