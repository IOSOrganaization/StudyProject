...
@interface PhotoHandoffViewController () <NSUserActivityDelegate>
...
@implementation PhotoHandoffViewController
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)cv cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    PhotoHandoffCell *cell = [cv dequeueReusableCellWithReuseIdentifier:kCellID forIndexPath:indexPath];
