...
#import "PhotoHandoff.h"
#import "PhotoHandoffDataSource.h"
#import "PhotoHandoffViewController.h"

@interface PhotoHandoff ()
@property (nonatomic, readwrite) PhotoHandoffDataSource *dataSource;
@end


#pragma mark -

@implementation PhotoHandoff

// easy access to our primary collection view controller
- (PhotoHandoffViewController *)primaryViewController
{
...
- (void)viewDidLoad{
    ...
    self.dataSource = [[PhotoHandoffDataSource alloc] init];
    ...
    PhotoHandoffViewController *primaryViewController = [self primaryViewController];
...
- (BOOL)application:(UIApplication *)application continueUserActivity:(NSUserActivity *)userActivity restorationHandler:(void (^)(NSArray *))restorationHandler {
    ...
    PhotoHandoffViewController *viewController = (PhotoHandoffViewController *)(navigationController.viewControllers)[0];
