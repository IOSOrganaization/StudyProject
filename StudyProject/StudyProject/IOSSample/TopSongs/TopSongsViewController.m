...
//  StudyProject
//
//  Created by XiaoTian on 1/15/15.
...
@interface TopSongsViewController ()

@property (nonatomic, strong) TopSongsSongsViewController *songsViewController;
...
- (void)viewDidLoad {
    ...
    _songsViewController = (TopSongsSongsViewController *)self.visibleViewController;
